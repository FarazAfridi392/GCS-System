import 'package:e_shop/Buyer/models/user.dart';
import 'package:e_shop/Buyer/Screens/payment_history_page.dart';
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.symmetric(vertical: 8.0),
                                child: Text('10% off on any rahat products',
                                    style: TextStyle(
                                      color: Colors.grey,
                                      fontSize: 10.0,
                                    )),
